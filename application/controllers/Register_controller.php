...
class Register_controller extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('view_frontend/register',$data);
	...
	public function submit(){
		...
		if(md5($captcha)==$this->session->userdata('keycode')){
			...
			redirect('register_controller?cap_error=1','refresh');
		}
		...
		$data = array(
			'slug' => $this->input->post('firstname').'-detail',
