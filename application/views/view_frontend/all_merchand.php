<div class="content">
	<div class="container">
		<div class="row">
			<div class="col-md-12 header-content"><h4>All Merchand</h4></div>
			<div class="col-md-12">
				<?php
				if (count($list_data_merchand) > 0) {
					foreach($list_data_merchand as $row)
					{

						?>
						<div class="col-sm-3 col-md-3">
							<div class="thumbnail content-post-child" >
								<h4 class="text-center"><span class="label label-info"><?php $brand=$row['brand_merchand']; echo substr($brand,0,10);?></span></h4>
								<img  class="img-responsive" src= "<?php echo base_url().'assets/image/product/'.$row['image_merchand']; ?>">
								<div class="caption">
									...
									<div class="row">
										...
										<div class="col-md-6">
											<?php echo form_open_multipart('cart_controller/add'); ?>
												...
												<input type="hidden" name="barcode_product" value="<?php echo $row['barcode_merchand'] ?>">
