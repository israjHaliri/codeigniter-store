	...
	<div class="grid">
		<div class="panel panel-default">
			...
			<div class="panel-body "  style=" overflow: scroll;">
				...
				<div class="col-md-12">
					<?php echo form_open_multipart('backend_controller/merchand_controller/insert_data'); ?>
					...
					<div class="form-group">
						<label>Barcode</label>
						<input type="text" name="barcode_merchand" class="form-control" requrired>
					</div>
					<div class="form-group">
						<label>Brand</label>
						<input type="text" name="brand_merchand" class="form-control" required>
					</div>
					<div class="form-group">
						<label>Size</label>
					...
					<div class="form-group">
						...
						<textarea name="describe_merchand" class="ckeditor" class="form-control"></textarea> 
					</div>
					<div class="form-group">
						<label>Image</label>
