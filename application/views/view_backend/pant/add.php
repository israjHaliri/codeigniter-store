	...
	<div class="grid">
		<div class="panel panel-default">
			...
			<div class="panel-body "  style=" overflow: scroll;">
				...
				<div class="col-md-12">
					<?php echo form_open_multipart('backend_controller/pant_controller/insert_data'); ?>
					...
					<div class="form-group">
						<label>Barcode</label>
						<input type="text" name="barcode_pant" class="form-control" requrired>
					</div>
					<div class="form-group">
						<label>Brand</label>
						<input type="text" name="brand_pant" class="form-control" required>
					</div>
					<div class="form-group">
						<label>Size</label>
					...
					<div class="form-group">
						...
						<textarea name="describe_pant" class="ckeditor" class="form-control" required></textarea> 
					</div>
					<div class="form-group">
						<label>Image</label>
